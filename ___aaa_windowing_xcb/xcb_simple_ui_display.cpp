...
i64 simple_ui_display::add_ref(OBJECT_REFERENCE_COUNT_DEBUG_PARAMS_DEF)
{

   return xcb_hook::add_ref(OBJECT_REFERENCE_COUNT_DEBUG_ARGS);

}


i64 simple_ui_display::dec_ref(OBJECT_REFERENCE_COUNT_DEBUG_PARAMS_DEF)
{

   return xcb_hook::dec_ref(OBJECT_REFERENCE_COUNT_DEBUG_ARGS);

}


i64 simple_ui_display::release(OBJECT_REFERENCE_COUNT_DEBUG_PARAMS_DEF)
{
