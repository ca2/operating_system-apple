...
//               HICON hicon = (HICON)LoadImage(nullptr, path, IMAGE_ICON, iSize, iSize, LR_LOADFROMFILE);
         ...
         if (strIcon48.has_character())
         {
            ...
            pimage->get_graphics()->stretch(::i32_size(16, 16), pimage1->get_graphics(), pimage1->rectangle());

            pimage->get_graphics()->set_interpolation_mode(::draw2d::e_interpolation_mode_high_quality_bicubic);

            pimage->get_graphics()->stretch(::i32_size(48, 48), pimage->get_graphics(), pimage->rectangle());
...
//
//               m_pilHover[iSize]->draw(pimage->get_graphics(), iImage, ::i32_point(), 0);
...
//               i32_size s = m_pil[iSize]->m_pimage->get_size();
//               ::image_pointer pimage;
...
//               m_pil[iSize]->m_pimage->g()->draw(::i32_point(), d->size(), pimage->get_graphics());
