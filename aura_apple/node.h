...
//
      ...
      public:
         ...
         ::image::image_pointer get_file_image_by_type_identifier(int iSize, const ::scoped_string & scopedstrTypeIdentifier, ::acme::user::interaction * pacmeuserinteractionAffinity) override;

         ::image::image_pointer get_file_image(int iSize, const ::file::path & path, ::acme::user::interaction * pacmeuserinteractionAffinity) override;
