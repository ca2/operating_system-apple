...
::draw2d::bitmap_pointer image::get_bitmap_as_source(::draw2d::graphics * pdraw2dgraphics) const  // is semantically const (besides may not be implementationly constant)
{
   
   return ::image::image::get_bitmap_as_source(pdraw2dgraphics);
   
}
::draw2d::bitmap_pointer image::get_bitmap_as_target(::draw2d::graphics * pdraw2dgraphics ) const  // is semantically const (besides may not be implementationly constant)
