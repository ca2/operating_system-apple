   ...
   namespace midi
   {
      ...
      namespace core_midi
      {
         ...
         //   virtual void pitch_bend(const int value, const int channel) = 0;
            ...
            void note_on(int iChannel, unsigned char uchNote, unsigned char uchVelocity) = 0;
            void note_off(int iChannel, unsigned char uchNote, unsigned char uchVelocity) = 0;
            void program_change(int iChannel, unsigned char uchProgram) = 0;
