   ...
   namespace midi
   {
      ...
      namespace core_midi
      {
         ...
         public:
            ...
            virtual ::e_status translate_os_result(string & strMessage, string & strOsMessage, ::music::midi::object * pobject, long long iOsResult, const string & strContext, const string & strText) override;
